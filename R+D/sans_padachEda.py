...
def is_swara (c):
    vowel = ['ऀ', 'ँ', 'ं', 'ः', 'ऄ	', 'अ', 'आ', 'इ', 'ई', 'उ', 'ऊ', 'ऋ' 'ॠ', 'लृ', 'ॡ', 'ऍ', 
    'ऎ', 'ए', 'ऐ', 'ऑ', 'ऒ', 'ओ', 'औ', 'ऺ', 'ऻ', '़', 'ऽ', 
    'ा', 'ि', 'ी', 'ु', 'ू', 'ृ', 'ॄ', 'ॅ', 'ॆ', 'े', 'ै', 'ॉ', ' ॊ',  
    'ो', 'ौ', '्', 'ॎ', 'ॏ']   
    #TODO many bugs in splitting vowels w/ aksharas, also look at spacing and how aksharas are split
    for i in vowel:
        if i == c:
            return True
    return False
...
def is_vyanjana(c):
    vyanjana = ['क', 'ख', 'ग', 'घ', 'ङ', 'च', 'छ', 'ज', 'झ', 'ञ', 'ट', 'ठ', 'ड', 'ढ', 'ण', 'त', 'थ', 
             'द', 'ध', 'न', 'प', 'फ', 'ब', 'भ', 'म', 'य', 'र', 'ल', 'व', 'श', 'ष', 'स', 'ह', 'ळ']
    for i in vyanjana:
        if i == c:
            return True
    return False
